...
public class AIBoardTTT : AIBoard
{
    ...
    private AIBoardTTT(int[,] board, int player)
    {
        this.board = board;
        this.player = player;
    }
    ...
    public override MoveAI[] GetMoves()
    {
        var moves = new List<MoveAI>();
    ...
    public override AIBoard MakeMove(MoveAI m)
    {
        ...
        return new AIBoardTTT(boardCopy, nextPlayer);
    }
